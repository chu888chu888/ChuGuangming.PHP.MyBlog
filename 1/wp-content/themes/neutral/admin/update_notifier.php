...
add_dashboard_page( $theme_data['Name'] . 'Theme Updates', __('Theme Update<span class="update-plugins count-1"><span class="update-count">1</span></span>', 'neutral'), 'administrator' , 'neutral-updates', 'update_notifier');
	}
}  
 ...
 ?>
	...
	<style>
        ...
        <div class="wrap">
         ...
         <h2><?php echo $theme_data['Name']; ?><?php _e('Theme Update Information', 'neutral');  ?></h2>
         <div id="message" class="updated below-h2">
          <p><?php _e('Current theme version is', 'neutral'); ?><?php echo $theme_data['Version']; ?><br /><?php _e('Now you can update to', 'neutral');  ?><?php echo $xml->latest; ?></p>
         </div>
         <div id="mono_instructions">
          <h3><?php _e('Please take backup of your theme before updating to latest version!', 'neutral');  ?></h3>
          <p style="font-size:16px;">【 <a href="http://www.mono-lab.net/wp-content/uploads/neutral.zip"><?php _e('Download latest version', 'neutral');  ?></a> 】</p>
          <div id="mono_info">
	   <h3><?php _e('Changelog', 'neutral');  ?></h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://www.mono-lab.net/notifier/neutral.xml';
